...
./home/Jonathan/NTI-320/automation_scripts/generate_config.sh ldap-server 10.138.0.9              # code I gave you in a previous assignment that generates a nagios config
